...
var pages = {
	1: {
		...
		["res://assets/objects/Green.png"]: "THIS IS SOME KIND OF A SOLID GROUND, IN FACT IT IS A MIXTURE OF MUDD AND DIRT. IT CAN HOLD OBJECTS ON TO OF IT SO THAT THE OBJECTS WON'T FALL DOWN. YOU CAN GO RHOGUH IT, AND IT WILL VANISH",
		...
		["res://assets/objects/Destroyable_Bars_Slippery.png", "res://assets/objects/Destroyable_Bars_H.png", "res://assets/objects/Destroyable_Bars_V.png", "res://assets/objects/Destroyable_Wall_1_H.png", "res://assets/objects/Destroyable_Wall_1_V.png"]: "THOSE ARE DIFFERENT KINDS OF WALLS. YOU CAN DESTROY THEM (IF YOU HAVE BOMB)...",
	...
	2: {
		...
		["res://assets/objects/Rock.png"]: "THIS IS A STONE. IT CAN KILL YOU IF IT FALLS ON YOU... AVOID THAT!... YOU CAN DESTROY IT AND MOVE IT, YOU CAN ALSO KILL SOMEONE WITH IT IF YOU ARE CLEVER ENEOUGH.",
		...
		["empty2"]: "THESE OBJECTS HAVE NO PARTUCULAR PRUPOSE EXCEPT MAYBE TO STOP YOU.",
	...
	3: {
		...
		["res://assets/fishes/Fish_Taba_Down.png"]: "THIS IS YOUR MOST DANGEROUS ENEMY. (PRETTY FACE). NOW READ CAREFULLY... YOU DON'T WANT TO KNOW HIM (IF YOU WANT TO LIVE). HE'LL EAT YOUR WITHOUT ANY WARNING, SO STAY AWAY.",
		["res://assets/fishes/Fish_Haha_Down.png"]: "THIS SHARK LIKES YOU VERY MUCH, ESPECIALLY FOR BREAKFAST. BUT YOU CAN EASILY ESCAPE BECAUSE THE SHARK ALWAYS LAUGHS WHEN 'DINNER IS SERVED' THIS SHARK WILL EAT FISH THAT YOU AHVE TO COLLECT, BE QUICK!",
	...
	4: {
		["empty1"]: "OK, THAT'S ENOUGH ABOUT THE BAD GUYS, NOW WE'LL SEE WHO YOUR 'FRIENDS' ARE... THEE WORD 'FIRNEDS' MEANS THAT THEY WILL NOT KILL YOU, NOT ON PURPOSE ANYWAY. HOWEVER... ACCIDENTS DO HAPPEN. OK! LE'S GET DOWN TO BUSINESS...",
		["res://assets/fishes/Fish_3_Down.png", "res://assets/fishes/Fish_2_Down.png"]: "COLLECT THESE FISH!",
		["res://assets/fishes/Fish_1_1.png"]: "AND COLLECT THIS TOO!",
		["empty2"]: "YOU WILL HAVE TO COLLECT THESE THREE FISH IN ORDER TO OPEN THE EXIT TO THE NEXT LEVEL.",
		["res://assets/objects/Bomb.png"]: "COLLECT THIS ALSO! YOU'LL BE NEEDING THIS BOMB, FIRST TO SATISFY YOUR DESTRUCTIVE NEEDS, AND SECOND, TO GET THINGS OUT OF YOUR WAY.",
	...
	5: {
		["empty1"]: "NOW THAT YOU KNOW HOW TO USE THE BOMB, YOU MUST KNOW THAT IT'S NOT WISE TO PLAY WITH IT, AND YOU MUST USE IT VERY CAREFILY IN ORDER TO ACHIEVE SOMETHING. OH! I ALMOST FORGOT! YOU DON'T HAVE ALL THE TIME IN THE WORLD BECASUE YOU CAN'T BREATHE UNDER THE WATER... UNLESS YOU HAVE THIS:",
		["res://assets/objects/Oxygen_1.png"]: "THIS IS OXYGEN. YOU'LL BE NEEDING IT IN ORDER TO STAY ALIVE.",
		["empty2"]: "IF YOU WANT TO KNOW HOW LONG YOU HAVE BEEN PLAYING, TAKEE A LOOK AT THE SCOREBAR. NOW, LET'S CONTINUE...",
	...
	6: {
		...
		["res://assets/fishes/Fish_Yellow_Down.png"]: "THIS FISH STICK ON YOUR FISH THAT YOU AHVE TO COLLECT. YOU MUST BE VERY CAREFUL BECAUSE... NAH, YOU'LL SEE FOR YOURSELF!",
